        ...
        <div id='try' className="py-[60px] 2xl:py-[70px] w-full h-full font-andada bg-gradient-to-r from-purple-300 via-purple-200 to-pink-200 transform -skew-x-10 flex justify-center items-center">
            <div className="flex flex-col justify-center items-center w-[250px] 2xl:w-fit text-center">
                ...
                <div className="flex flex-col gap-4">
                    <Button route='/signup' text='Try Spendwise Free' width='w-[240px] 2xl:w-[420px]' height='h-[44px] 2xl:h-[64px]' bg='bg-[#19AD50CC]' rounded='rounded-[10px]' size='text-[16px] 2xl:text-[25px]' color='text-white' bold='font-semibold 2xl:font-bold' font='font-inter' />
                    <Button route='/signup' text='See Site Features' width='w-[240px] 2xl:w-[420px]' height='h-[44px] 2xl:h-[64px]' bg='bg-[#ffffff]' rounded='rounded-[10px]' size='text-[16px] 2xl:text-[25px]' color='text-black' bold='font-semibold 2xl:font-bold' font='font-inter' />
                </div>
            </div>
        </div>
    );
