const BarChart = ({ expense, income }) => {
    ...
    return (
        <div className="w-full h-full min-h-[300px] flex justify-between items-center pr-[40px] pb-[20px]">
            <div className="w-[50%] h-full flex flex-row justify-center items-center">
                <div
                    className="bar-income w-[40px] bg-[#22A447] rounded-[10px] mr-6"
                    style={{
                ...
                ></div>
                <div
                    className="bar-expense w-[40px] bg-[#E81E1E] rounded-[10px]"
                    style={{
