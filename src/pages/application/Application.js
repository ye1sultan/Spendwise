...
const Application = () => {
    ...
    return (
        <div className="font-montserrat bg-white flex flex-col justify-between items-center w-[300px] h-full border-r-2 py-14">

            <div>
                <div className='text-3xl w-[230px] font-semibold z-50 p-4 mb-4'>LOGO</div>
